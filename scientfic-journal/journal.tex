...
\begin{center}
    \texttt{\$ netstack curl -vv https://github.com/frebib/netd}
\end{center}
...
One of the defining features of TCP is the famous \textit{three-way handshake} that every connection begins and ends with.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex]
        ...
        % \texttt{ACK}
        \draw[->] (LD) -- (RE) node[midway,sloped,above]{\verb$SACK$};
        \draw (RE) node[right]{%
            \begin{tabular}{l}
                \verb$ESTABLISHED$\
            \end{tabular}
